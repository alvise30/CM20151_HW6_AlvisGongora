...
int rk4_step(float ***r, float ***v, float ***a, float ***kr, float ***kv, float ***ri, float ***vi, floar *m, float h, int n_cuerpos, n_coordenadas, int cuerpo, int step, int coodernada){
